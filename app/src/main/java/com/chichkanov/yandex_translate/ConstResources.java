...
public class ConstResources {
    ...
    final static String PREFS_SPINNERS_STATE = "spinners_state";
    final static String PREFS_CACHE_NAME = "translation_cache";
    final static String PREFS_FAV_NAME = "translation_cache";

    final static HashMap<String, String> LANGUAGES = createMap();
    final static String KEY = "trnsl.1.1.20170415T124611Z.ad6b17355364d141.64ba3777be0638c0334939d343b1920945530598";
